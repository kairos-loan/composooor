...
export interface ComposooorRegisterInterface extends utils.Interface {
    functions: {
...
export interface ComposooorRegister extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ComposooorRegisterInterface;
