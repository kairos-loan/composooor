...
export interface MarketPlaceComposoooredInterface extends utils.Interface {
    functions: {
        "recordParameter(bytes)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "recordParameter"): FunctionFragment;
...
export interface MarketPlaceComposooored extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MarketPlaceComposoooredInterface;
