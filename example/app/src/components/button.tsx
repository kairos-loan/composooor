...
import { UseAsyncReturn, useAsync, useComposooor } from '@composooor/composooor';
...
const ButtonPay = () => {
  ...
  const { write } = useComposooor({
    scWalletAddr: import.meta.env.VITE_WALLET ?? '0x5FC8d32690cc91D4c39d9d3abcBD16989F875707' as `0x${string}`,
    address: import.meta.env.VITE_BUYNOWPAYLATER ?? '0x0165878A594ca255338adfa4d48449f69242Eb8F' as `0x${string}`,
